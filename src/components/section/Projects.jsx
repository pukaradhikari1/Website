                 ...
                 text-transparent  text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                     ...
                     hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                            ...
                            <p className="text-gray-400 mb-4">
                                This project focuses on the development of an intelligent plant disease detection system
                                using image processing and machine learning techniques. By analyzing leaf images, the system
                                identifies plant diseases at an early stage and provides accurate predictions to support farmers
                                and agricultural researchers. The solution aims to improve crop health, reduce losses, and promote
                                sustainable farming practices through timely and reliable disease diagnosis.
                            </p>
                            <div className="flex flex-wrap gap-2 mb-4">
                                {["Flask", "React", "Tailwind CSS", "TensorFlow", "OpenCV"].map((tech, key) => (
                                    <span
                                        key={key}
                                        className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm
                                     hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
                            ...
                            <div className="flex justify-between items-center">
                                <a href="https://github.com/pukaradhikari1/Plant-Disease-detection"
                                    className="text-blue-400 hover:text-blue-300 transition-colors my-4">
                                    View Project➡️
                                </a>
                            </div>
